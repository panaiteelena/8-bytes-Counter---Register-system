...
HD_PWD='C:/Users/leo/Documents/Proiect/Proiect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SequentialSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SequentialSystem.tcl
