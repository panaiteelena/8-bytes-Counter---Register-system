...
HD_PWD='C:/Users/leo/Documents/Proiect/Proiect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SequentialSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SequentialSystem.tcl -notrace
